    ...
    liquidity: [
      {
        ...
        interpretation: "Measures the business's ability to pay short-term obligations",
        businessImplication: `With a current ratio of ${(data.currentAssets / data.currentLiabilities).toFixed(2)}, the business ${data.currentAssets / data.currentLiabilities >= 2 ? "has excellent short-term financial health. The business can easily cover current liabilities and has substantial working capital for operations and growth opportunities." : data.currentAssets / data.currentLiabilities >= 1.5 ? "maintains good liquidity position. The business can comfortably meet short-term obligations while maintaining operational flexibility." : data.currentAssets / data.currentLiabilities >= 1 ? "has adequate liquidity but should monitor cash flow closely. The business should consider improving collection processes or managing inventory more efficiently." : "faces liquidity challenges. Immediate action needed to improve cash position - the business should consider accelerating receivables collection, extending payables terms, or securing additional funding."}`,
