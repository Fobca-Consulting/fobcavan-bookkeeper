...
const ClientDashboard = () => {
  ...
  const businessData = businesses.find(b => b.id === clientId) || { name: "Client" };

  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold">{businessData.name} Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="col-span-2">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Link to={`/client/${clientId}/transactions`} className="text-sm text-primary hover:underline flex items-center">
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <Button className="w-full justify-start" variant="outline" asChild>
              <Link to={`/client/${clientId}/transactions`}>
                <CreditCard className="mr-2 h-4 w-4" />
                Add Transaction
              </Link>
            </Button>
            <Button className="w-full justify-start" variant="outline" asChild>
              <Link to={`/client/${clientId}/customers`}>
                <Users className="mr-2 h-4 w-4" />
                Add Customer
              </Link>
            </Button>
            <Button className="w-full justify-start" variant="outline" asChild>
              <Link to={`/client/${clientId}/vendors`}>
                <ShoppingCart className="mr-2 h-4 w-4" />
                Add Vendor
              </Link>
            </Button>
            <Button className="w-full justify-start" variant="outline" asChild>
              <Link to={`/client/${clientId}/reports`}>
